...
export default function Contact() {
  return (
    <section
      id="contact"
      className="scroll-mt-16 bg-primary py-24 text-primary-foreground"
    >
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1 text-sm text-primary-foreground/65">
              {contactLinks.whatsapp.replace("https://wa.me/", "+")}
            </p>
          </a>
          <a
          ...
          >
            ...
            <p className="mt-1 text-sm text-primary-foreground/65">
              {contactLinks.phone.replace("tel:", "")}
            </p>
          </a>
          <a
          ...
          >
            ...
            <p className="mt-1 text-sm text-primary-foreground/65">
              {contactLinks.email.repeat(1).replace("mailto:", "")}
            </p>
          </a>
        </div>
      </div>
